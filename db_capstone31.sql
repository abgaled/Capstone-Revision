...
(6, 1, 2018, '5000000.00', '4982630.00'),
...
(31, 44, NULL, 'BENEFIT FOR BARANGAY', 1, 'pc'),
(32, 45, NULL, 'benefet1111', 3, 'pc');
...
(27, 4, 44, 'Barangay', 'Approved', NULL, '2018-10-28 18:47:47'),
(28, 9, 44, 'Barangay', 'Approved', NULL, '2018-10-28 18:48:38'),
(29, 4, 45, 'Barangay', 'Approved', NULL, '2018-10-28 19:15:44');
...
(4, 27, 'lkjld', 'lkjdkl', 'lkjskl', '', '2018-10-28 18:41:31', '2345', 'ksldjclks'),
(5, 28, 'kjc', 'lkjkl', 'lskcjkls', '', '2018-10-28 18:41:31', '5234', 'ksl'),
(6, 29, 'Abs', 'DJC', 'DJ', '', '2018-10-28 19:23:06', '2345', 'kncjd'),
(7, 29, 'skh', 'ksjhk', 'kjsk', '', '2018-10-28 19:23:06', '2589', 'cnjs'),
(8, 29, 'jhkj', 'kjshk', 'kjhskj', '', '2018-10-28 19:23:06', '2485', 'kjshjk');
...
(9, 11, 'BENEFIT FOR BARANGAY', 5),
(10, 10, 'BENEFIT FOR BARANGAY', 1),
(11, 13, 'benefet1111', 20);
...
(10, 44, 4, 'Girly Diaz', '2018-10-28', NULL, 'Closed'),
(11, 44, 9, 'Hail Cruzadas', '2018-10-28', NULL, 'Closed'),
(12, 3, 4, NULL, NULL, NULL, 'Releasing'),
(13, 45, 4, 'Girly Diaz', '2018-10-28', NULL, 'Closed');
...
(15, 6, 3, '1000000.00', '996385.00'),
(16, 6, 4, '1500000.00', '1493245.00');
...
(53, 44, NULL, 'Benefit Expense', 20, '140.00', '0.00', '280.00', 2),
(54, 44, NULL, 'Food Expense', NULL, '120.00', NULL, '3600.00', 30),
(55, 45, NULL, 'Benefit Expense', 10, '210.00', '0.00', '630.00', 3),
(56, 45, NULL, 'Food Expense', NULL, '60.00', NULL, '1800.00', 30);
...
(34, 1, 1, NULL, 'Things for the babies', 'To help the pregnant women for their babies', '2018-10-12', 'Marivic Campos', '65 Addition Hills Mandaluyong City', 'Solved'),
...
(39, 4, 4, 44, 'BARANGAY SSAMPLE1', 'BARANGAY SSAMPLE1', '2018-10-28', 'Summer Autumn', '236 Hulo', 'Solved');
...
(44, 1, ' BARANGAY SSAMPLE1   ', 'BARANGAY SSAMPLE1', 'BARANGAY SSAMPLE1', 'BARANGAY SSAMPLE1', 20, '2018-10-29', '2018-11-15', '2018-11-20', '2018-11-20', '2018-11-22', '2018-10-28', '2018-10-28', '2018-10-28', '2018-10-28', '2018-10-28', '2018-10-28', '0.00', '5000.00', '3880.00', 'Finished'),
(45, 1, 'TEST RELEASING', 'KLJDCL', 'KLJDCL', 'KLJDCL', 10, '2018-10-30', '2018-11-14', '2018-11-22', '2018-11-22', '2018-11-28', '2018-10-28', '2018-10-28', '2018-10-28', '2018-10-28', '2018-10-28', '2018-10-28', '0.00', '5000.00', '2430.00', 'Finished');
...
(34, 44, 'KJKJ', 'Start Application'),
(35, 44, 'jlxkjsx', 'Close Application'),
(36, 44, 'kk.', 'Start Releasing'),
(37, 44, 'jk', 'Close Releasing'),
(38, 44, 'kljkl', 'Close Releasing'),
(40, 45, 'jnjk', 'Start Application'),
(41, 45, 'kljklj', 'Close Application'),
(42, 45, 'jkkj', 'Start Releasing'),
(43, 45, 'kjkkl', 'Close Releasing');
...
--
ALTER TABLE `tbl_applicantbenefit`
  MODIFY `int_appbeneID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
...
--
ALTER TABLE `tbl_barangaybeneficiary`
  MODIFY `int_brgybeneID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbl_barangaybenefit`
--
ALTER TABLE `tbl_barangaybenefit`
  MODIFY `int_projbenefitID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `tbl_barangayreleasing`
--
ALTER TABLE `tbl_barangayreleasing`
  MODIFY `int_brgyreleaseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tbl_expense`
  MODIFY `int_expenseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `tbl_projectapplicationtype`
  MODIFY `int_proapptypeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `tbl_projectbeneficiary`
--
ALTER TABLE `tbl_projectbeneficiary`
  MODIFY `int_projbeneID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;

--
-- AUTO_INCREMENT for table `tbl_projectcategory`
--
ALTER TABLE `tbl_projectcategory`
  MODIFY `int_projcategID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;

--
-- AUTO_INCREMENT for table `tbl_projectdetail`
--
ALTER TABLE `tbl_projectdetail`
  MODIFY `int_projectID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;

--
-- AUTO_INCREMENT for table `tbl_projectreason`
--
ALTER TABLE `tbl_projectreason`
  MODIFY `int_projectReasonID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT for table `tbl_projectrequirement`
--
ALTER TABLE `tbl_projectrequirement`
  MODIFY `int_projreqID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `tbl_projectsponsor`
--
ALTER TABLE `tbl_projectsponsor`
  MODIFY `int_projsponID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tbl_sponsordetail`
  MODIFY `int_sponsorID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
