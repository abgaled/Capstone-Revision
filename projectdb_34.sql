...
(33, 1, 1, NULL, 'Eye glasses giving for senior citizens', 'To help the senior citizens', '2018-10-13', 'Zyannah Ombre', '63 Addition Hills Mandaluyong City', 'Acknowledged'),
(34, 1, 1, NULL, 'Things for the babies', 'To help the pregnant women for their babies', '2018-10-12', 'Marivic Campos', '65 Addition Hills Mandaluyong City', 'Acknowledged');
...
--
ALTER TABLE `tbl_barangayreleasing`
  MODIFY `int_brgyreleaseID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_officialsaccount`
  MODIFY `int_officialsuserID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `tbl_sponsordetail`
  MODIFY `int_sponsorID` int(11) NOT NULL AUTO_INCREMENT;
